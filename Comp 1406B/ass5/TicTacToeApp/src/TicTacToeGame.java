public class TicTacToeGame{
  ...
  public static void main(String[] args){
    ...
    TicTacToePlayer p1 = new TicTacToePlayer("joe", 'o');
    TicTacToePlayer p2 = new TicTacToePlayer("jane", 'x');
    ...
    TicTacToePlayer winner = TicTacToePlayer.winner(board, p1, p2);
    System.out.println(winner.getXO());*/
    
    
    board.play(5, p1);
    board.play(4, p1);
    System.out.println(board.show());
    System.out.println(p1.findWinningMove(board));
  }  
}