...
// function prototypes of functions we will use in the main
// function.  Their definitions are under the main function.
//
...
int main()
{
    ...
    //
    int numbers2[20] = {2,4,6,8,10};
    std::cout << "integer arrays with partial initialization" << std::endl;
    printIntArray(numbers, 10);
    printIntArray(numbers2, 20);
